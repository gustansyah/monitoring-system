  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const [serverResponse, logsResponse, userActivityResponse] = await Promise.all([
        ...
        axios.get(`${API_URL}/monitor/logs?lines=50&level=${logFilter}`, { headers }),
      ...
      <main className="dashboard-content">
        ...
        <div className="dashboard-grid">
          ...
          <div className="dashboard-card">
            ...
            <div className="card-description">
              Active: {getActiveUsers()} | Recent Logins: {getRecentLogins()}
            </div>
          </div>
          ...
          <div className="dashboard-card">
            ...
            <div className="card-description">
              Memory Usage | Response Time: {serverStatus?.responseTime || 'N/A'}
            </div>
          </div>
